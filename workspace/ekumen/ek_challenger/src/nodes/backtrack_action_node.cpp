...
BT::NodeStatus BacktrackActionNode::tick()
{
    ...
    ros::Publisher pub = nh_.advertise<geometry_msgs::Twist>("/servoing_cmd_vel", 10);
    ros::Subscriber sub = nh_.subscribe("/mobile_base_controller/odom", 10, &BacktrackActionNode::odomCallback, this);
